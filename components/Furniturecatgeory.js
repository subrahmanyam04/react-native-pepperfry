    ...
    return (
            <controls.View style={styles.mainconatiner}>
                    ...
                    <controls.View style={styles.container}>
                        <controls.View style={styles.subcontainer}>
                            <controls.View style={styles.imagecontainer}>
                                <controls.Image source={{ uri: 'https://ii1.pepperfry.com/media/wysiwyg/banners/Furniture_LogoIcon_2x_0307.jpg' }} style={styles.image} />
                            </controls.View>
                            <controls.View style={{ width: "76%" }}>
                                <controls.Text style={styles.headingtext}>Furniture</controls.Text>
                        ...
                        <controls.View style={styles.nestedcontainer}>
                            <controls.View>
                                <controls.TouchableOpacity activeOpacity={1} >
                                    <controls.Text style={styles.Activetextcolor} onPress={() => navigateToScreen('3 Seater Sofas')}>3 Seater Sofas</controls.Text>
                                </controls.TouchableOpacity>
                            </controls.View>
                ...
                {isContainer2Visible ? (
                    <controls.View style={styles.dropdowmpannelcontainer}>
                        <controls.View style={styles.pannelinnercontainer}>
                            <controls.TouchableOpacity activeOpacity={1} onPress={() => navigateToScreen('Sofa Cum Beds')}>
                                <controls.View style={styles.innercontainer}>
                                    <controls.View><controls.Text style={styles.Activeheadertext}>Sofa Cum Beds</controls.Text></controls.View>
                                </controls.View>
                            </controls.TouchableOpacity>
                        </controls.View>
                    </controls.View>
