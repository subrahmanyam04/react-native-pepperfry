                ...
                <controls.View style={styles.container}>
                    <controls.View style={styles.subcontainer}>
                        <controls.View style={styles.imagecontainer}>
                            <controls.Image source={{ uri: 'https://ii1.pepperfry.com/media/wysiwyg/banners/furnishingsappliances_13042023.jpg' }} style={styles.image} />
                        </controls.View>
                        <controls.View style={{ width: "76%" }}>
                            <controls.Text style={styles.headingtext}>Furnishings</controls.Text>
                    ...
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity onPress={handlenestedcontainer1Click} activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.innercontainerheadtext}>Bed Sheets</controls.Text></controls.View>
                                <controls.View style={styles.iconcontainer}>
            ...
            {isnestedcontainer1Visible ? (
                <controls.View style={styles.nestedmaincontainer}>
                    <controls.View style={styles.nestedcontainer}>
                        <controls.View><controls.Text style={styles.Activetextcolor} onPress={() => navigateToScreen('Single Bed Sheets')}>Single Bed Sheets</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Queen Bed Sheets</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>King Bed Sheets</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Fitted Bed Sheets</controls.Text></controls.View>
                    </controls.View>
                </controls.View>
            ) : null}
            {isContainer2Visible ? (
                ...
                <controls.View style={styles.dropdowmpannelcontainer}>
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.Activeheadertext} onPress={() => navigateToScreen('Furnishings Gift Sets')}>Furnishings Gift Sets</controls.Text></controls.View>
                            </controls.View>
                        </controls.TouchableOpacity>
                    </controls.View>
                </controls.View>
