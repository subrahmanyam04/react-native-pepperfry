...
const Productsslider3 = () => {
    const sliderdata = [
        { id: 1, imageuri: "https://ii1.pepperfry.com/media/catalog/product/e/l/236x260/elegant-3-seater-sofa-in-grey-colour-elegant-3-seater-sofa-in-grey-colour-akttix.jpg", title: "", },
        { id: 2, imageuri: "https://ii1.pepperfry.com/media/catalog/product/m/u/236x260/multicolor-floral-280-tc-cotton-blend-single-bed-bedsheet-with-1-pillow-cover-by-hosta-homes-multico-m3vkab.jpg", title: "", },
        { id: 3, imageuri: "https://ii1.pepperfry.com/media/catalog/product/s/i/236x260/silver-2-ltrs-induction-base-outer-lid-aluminium-pressure-cooker-silver-2-ltrs-induction-base-outer--jdowx3.jpg", title: "", },
        ...
        { id: 5, imageuri: "https://ii1.pepperfry.com/media/catalog/product/d/a/236x260/daroo-3-seater-sofa-in-camel-beige-by-febonic-daroo-3-seater-sofa-in-camel-beige-by-febonic-o8dhfm.jpg", title: "", },
    ...
    return (
        <controls.View style={styles.container}>
            <controls.View style={{ marginBottom: 16 }}>
                <controls.Text style={{ color: 'brown', fontWeight: '900', fontSize: 20 }}>Recently Viewed</controls.Text>
            </controls.View>
