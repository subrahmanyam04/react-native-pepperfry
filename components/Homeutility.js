                ...
                <controls.View style={styles.container}>
                    <controls.View style={styles.subcontainer}>
                        <controls.View style={styles.imagecontainer}>
                            <controls.Image source={{ uri: 'https://ii1.pepperfry.com/media/wysiwyg/banners/utility_13012023.jpg' }} style={styles.image} />
                        </controls.View>
                        <controls.View style={{ width: "76%" }}>
                            <controls.Text style={styles.headingtext}>Home Utility</controls.Text>
                    ...
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity onPress={handlenestedcontainer1Click} activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.innercontainerheadtext}>Storage & Organizers</controls.Text></controls.View>
                                <controls.View style={styles.iconcontainer}>
            ...
            {isnestedcontainer1Visible ? (
                <controls.View style={styles.nestedmaincontainer}>
                    <controls.View style={styles.nestedcontainer}>
                        <controls.View><controls.Text style={styles.Activetextcolor} onPress={() => navigateToScreen('Cloth Organizers')}>Cloth Organizers</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Drawer Organizers</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Shoe Organizers</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Hook & Hangers</controls.Text></controls.View>
                    </controls.View>
                </controls.View>
            ) : null}
            {isContainer2Visible ? (
                ...
                <controls.View style={styles.dropdowmpannelcontainer}>
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.Activeheadertext} onPress={() => navigateToScreen('Masks')}>Masks</controls.Text></controls.View>
                            </controls.View>
                        </controls.TouchableOpacity>
                    </controls.View>
                </controls.View>
