                ...
                <controls.View style={styles.container}>
                    <controls.View style={styles.subcontainer}>
                        <controls.View style={styles.imagecontainer}>
                            <controls.Image source={{ uri: 'https://ii1.pepperfry.com/media/wysiwyg/banners/home_decorappliances_13042023.jpg' }} style={styles.image} />
                        </controls.View>
                        <controls.View style={{ width: "76%" }}>
                            <controls.Text style={styles.headingtext}>Homedecor</controls.Text>
                    ...
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity onPress={handlenestedcontainer1Click} activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.innercontainerheadtext}>Vases</controls.Text></controls.View>
                                <controls.View style={styles.iconcontainer}>
            ...
            {isnestedcontainer1Visible ? (
                <controls.View style={styles.nestedmaincontainer}>
                    <controls.View style={styles.nestedcontainer}>
                        <controls.View><controls.Text style={styles.Activetextcolor} onPress={() => navigateToScreen('Table Vases')}>Table Vases</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Floor Vases</controls.Text></controls.View>
                    </controls.View>
                </controls.View>
            ) : null}
            {isContainer2Visible ? (
                ...
                <controls.View style={styles.dropdowmpannelcontainer}>
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.Activeheadertext} onPress={() => navigateToScreen('Figurines')}>Figurines</controls.Text></controls.View>
                            </controls.View>
                        </controls.TouchableOpacity>
                    </controls.View>
                </controls.View>
