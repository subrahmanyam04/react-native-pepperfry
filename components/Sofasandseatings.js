...
const Sofasandseatings = () => {
    ...
    const titles = [
        ...
        { id: 2, tilname: 'Wing Chairs', onpressind: '', icon: ""},
    ...
    return (
        <controls.View style={styles.mainconatiner}>
                ...
                <controls.View style={styles.container}>
                    <controls.View style={styles.subcontainer}>
                        <controls.View style={styles.imagecontainer}>
                            <controls.Image source={{ uri: 'https://ii1.pepperfry.com/media/wysiwyg/banners/SofaSeating_LogoIcon_2x_2906.jpg' }} style={styles.image} />
                        </controls.View>
                        <controls.View style={{ width: "76%" }}>
                            <controls.Text style={styles.headingtext}>Sofas & Seatings</controls.Text>
                    ...
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity onPress={handlenestedcontainer1Click} activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.innercontainerheadtext}>Sofas</controls.Text></controls.View>
                                <controls.View style={styles.iconcontainer}>
            ...
            {isnestedcontainer1Visible ? (
                <controls.View style={styles.nestedmaincontainer}>
                    <controls.View style={styles.nestedcontainer}>
                        <controls.View><controls.Text style={styles.nestedtext}>3 Seater Sofas</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>2 Seater Sofas</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>1 Seater Sofas</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Sofa Sets</controls.Text></controls.View>
                    </controls.View>
                </controls.View>
            ) : null}
            {isContainer2Visible ? (
            ...
            {isnestedcontainer2Visible ? (
                <controls.View style={styles.nestedmaincontainer}>
                    <controls.View style={styles.nestedcontainer}>
                        <controls.View><controls.Text style={styles.Activetextcolor} onPress={() => navigateToScreen('LHS Sectional')}>LHS Sectional</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>RHS Sectional</controls.Text></controls.View>
                        <controls.View><controls.Text style={styles.nestedtext}>Corner Sofas</controls.Text></controls.View>
                    </controls.View>
                </controls.View>
            ) : null}
            {isContainer2Visible ? (
                <controls.View style={styles.dropdowmpannelcontainer}>
                    <controls.View style={styles.pannelinnercontainer}>
                        <controls.TouchableOpacity activeOpacity={1}>
                            <controls.View style={styles.innercontainer}>
                                <controls.View><controls.Text style={styles.Activeheadertext} onPress={() => navigateToScreen('Chaise Loungers')}>Chaise Loungers</controls.Text></controls.View>
                            </controls.View>
                        </controls.TouchableOpacity>
                    </controls.View>
                </controls.View>
                            ...
                            <controls.View style={styles.pannelinnercontainer}>
                                <controls.TouchableOpacity activeOpacity={1}>
                                    <controls.View style={styles.innercontainer}>
                                        ...
                                        <controls.View style={styles.iconcontainer}><controls.AntDesign name={add.icon} color={'#5B5B5B'} size={18} /></controls.View>
                                    </controls.View>
                                </controls.TouchableOpacity>
                            </controls.View>
                        </controls.View>
